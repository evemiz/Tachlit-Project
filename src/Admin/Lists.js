...
// import { readDocuments, addDocument, deleteDocument, updateDocument,MoveDoc  } from './AdminFunctions'; // Adjust the import path as necessary
...
//               <button className="lists-button" type="submit">{editMode ? 'אשר מתנדב חדש' : 'אשר'}</button>
